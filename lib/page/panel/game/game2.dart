...
import 'package:primaryschool/page/panel/game/data.dart';
import 'package:primaryschool/page/panel/game/flipcardgame.dart';

class Gametwo extends StatelessWidget {
...
class Gameltwo extends StatefulWidget {
  Gameltwo({Key key}) : super(key: key);

  @override
  _GameltwoState createState() => _GameltwoState();
}

class _GameltwoState extends State<Gameltwo> {
  Widget gamename() {
    return Text(
      'ກະລຸນາເລືອກຄວາມຍາກ',

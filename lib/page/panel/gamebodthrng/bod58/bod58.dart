...
import 'package:primaryschool/page/panel/gamebodthrng/bod58/quizbrain58.dart';
import 'package:rflutter_alert/rflutter_alert.dart';

QZ58 quiz2 = QZ58();


class Bod58 extends StatefulWidget {
  Bod58({Key key}) : super(key: key);

  @override
  _Bod58State createState() => _Bod58State();
}

class _Bod58State extends State<Bod58> {
 String setScore() {
  ...
  Widget kuppai() {
    return Container(
      child: FlatButton(
        onPressed: () {
          Navigator.pushReplacementNamed(context, '/lesson58');
        },
        child: Image.asset(
          "images/backtobt.png",
          width: 150.0,

...
import 'package:primaryschool/page/panel/gamebodthrng/bod31/quizbrain31.dart';
...
class Bod31 extends StatefulWidget {
  Bod31({Key key}) : super(key: key);

  @override
  _Bod31State createState() => _Bod31State();
}

class _Bod31State extends State<Bod31> {
 String setScore() {
  ...
  Widget kuppai() {
    return Container(
      child: FlatButton(
        onPressed: () {
          Navigator.pushReplacementNamed(context, '/lesson38');
        },
        child: Image.asset(
          "images/backtobt.png",
          width: 150.0,

...
import 'package:primaryschool/page/panel/gamebodthrng/bodt44/quizbrain44.dart';
import 'package:rflutter_alert/rflutter_alert.dart';

QZ44 quiz2 = QZ44();

class Bod44 extends StatefulWidget {
  Bod44({Key key}) : super(key: key);

  @override
  _Bod44State createState() => _Bod44State();
}

class _Bod44State extends State<Bod44> {
 String setScore() {
  ...
  Widget kuppai() {
    return Container(
      child: FlatButton(
        onPressed: () {
          Navigator.pushReplacementNamed(context, '/lesson44');
        },
        child: Image.asset(
          "images/backtobt.png",
          width: 150.0,

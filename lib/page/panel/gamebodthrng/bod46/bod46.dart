...
import 'package:primaryschool/page/panel/gamebodthrng/bod46/quizbrain46.dart';
import 'package:rflutter_alert/rflutter_alert.dart';


QZ46 quiz2 = QZ46();

class Bod46 extends StatefulWidget {
  Bod46({Key key}) : super(key: key);

  @override
  _Bod46State createState() => _Bod46State();
}

class _Bod46State extends State<Bod46> {
  String setScore() {
  ...
  Widget kuppai() {
    return Container(
      child: FlatButton(
        onPressed: () {
          Navigator.pushReplacementNamed(context, '/lesson46');
        },
        child: Image.asset(
          "images/backtobt.png",
          width: 150.0,

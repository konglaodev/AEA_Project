...
import 'package:primaryschool/page/panel/gamebodthrng/bod52/quizbrain52.dart';
import 'package:rflutter_alert/rflutter_alert.dart';

QZ52 quiz2 = QZ52();

class Bod52 extends StatefulWidget {
  Bod52({Key key}) : super(key: key);

  @override
  _Bod52State createState() => _Bod52State();
}

class _Bod52State extends State<Bod52> {
 String setScore() {
  ...
  Widget kuppai() {
    return Container(
      child: FlatButton(
        onPressed: () {
          Navigator.pushReplacementNamed(context, '/lesson52');
        },
        child: Image.asset(
          "images/backtobt.png",
          width: 150.0,

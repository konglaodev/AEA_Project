...
import 'package:primaryschool/page/panel/gamebodthrng/bodt10/quizbrain10.dart';


QZ10 quiz2 = QZ10();

class Bod10 extends StatefulWidget {
  Bod10({Key key}) : super(key: key);
 ...
 String setScore() {
  ...
  Widget kuppai() {
    return Container(
      child: FlatButton(
        onPressed: () {
          Navigator.pushReplacementNamed(context, '/lesson10');
        },
        child: Image.asset(
          "images/backtobt.png",
          width: 150.0,

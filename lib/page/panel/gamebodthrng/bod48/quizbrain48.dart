...
class QZ48 {
  ...
  List<Questions> _quizQuestions = [
    Questions('  ຟັງສຽງທາດໆ ນໍ້າ      ໂຕນຕາດຕີນຜາ','____________        ປ່ອງທາງທຽວນັ້ນ', 'ມັດສາຊາດຊື່ນຊ້ອຍ', 'ໄຫຼລົງມາຕາມແປວ',
        'ເນົາຢູ່ເຄຫາ', ' ຕາມຝັ່ງມີຕົ້ນໄມ້', 2),
    Questions('  ຕາມຝັ່ງມີຕົ້ນໄມ້         ເປັນຮົ່ມເງົາໜາ',' ____________       ຫຼົ່ນລົງຟູນໍ້າ', 'ມາລາຫອມ ', 'ຫຼິງໄປເທິງເນີນພູ', 'ເວີນຂັນນໍ້າປັ່ນ',
        'ມີດອກໃບສາຂາ', 4),
    Questions(' ຍາມຫນຶ່ງນົກເຕັນຜ້າຍ    ຜະຫຍອງເຜ່ນເວຫາ','______________      ແສ່ວຕຸມໂຕນນໍ້າ', 'ປ້ອມປິກລົງຈັບປາ',
        'ສັກກຸນາແຂກເຕົ້າ', 'ເບິ່ງມັນຫັນຈັ້ນໆ', 'ປະກອບເປັນປ່າໄມ້', 1),
    Questions(' ໄຫຼໄປຕາມສາຍຫ້ວຍ         ເວີນຂັນນໍ້າປັ່ນ','______________    ລອຍຄ້ວາງລ່ວງກາຍ', 'ເບິ່ງມັນຫັນຈັ້ນໆ',
        'ປ້ອມປິກລົງຈັບປາ', 'ໄຫຼລົງມາຕາມແປວ', 'ເນົາຢູ່ເຄຫາ', 1),
  ];

...
import 'package:primaryschool/page/panel/gamebodthrng/bod48/quizbrain48.dart';
import 'package:rflutter_alert/rflutter_alert.dart';

QZ48 quiz2 = QZ48();

class Bod48 extends StatefulWidget {
  Bod48({Key key}) : super(key: key);

  @override
  _Bod48State createState() => _Bod48State();
}

class _Bod48State extends State<Bod48> {
 String setScore() {
  ...
  Widget kuppai() {
    return Container(
      child: FlatButton(
        onPressed: () {
          Navigator.pushReplacementNamed(context, '/lesson48');
        },
        child: Image.asset(
          "images/backtobt.png",
          width: 150.0,

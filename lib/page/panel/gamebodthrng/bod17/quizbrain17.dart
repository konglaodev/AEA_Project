...
class QZ17 {
  ...
  List<Questions> _quizQuestions = [
    Questions(' ນອນສາຫຼ້າ       ຫຼັບຕາເອື້ອຍຊິກ່ອມ','  ______________   ຈຶ່ງມາເຝົ້າກ່ອມນອນ ', ' ດັງໄປທົ່ວບ້ານ', 'ນອນສາຫຼ້າ ',
        '  ເອອື້ຍນີ້ຫອມຮັກເຈົ້າ', 'ເຊັດຖູຮຽບຮ້ອຍ', 3),
    Questions('  ເອອື້ຍນີ້ຫອມຮັກເຈົ້າ      ຈຶ່ງມາເຝົ້າກ່ອມນອນ',' ______________    ແຕ່ລົມວອນວີວ່ອນ', 'ສຽງເນືອງນັນ', 'ຍັງບໍ່ທັນຕ່າວ', 'ດັງໄປທົ່ວບ້ານ',
        ' ມື້ນີ້ອາກາດຮ້ອນ', 4),
    Questions('  ນອນຫຼັບຕາສາແກ້ວ       ຫຼັບແລ້ວເອອື້ຍຊິໄກວ','______________       ຍັງບໍ່ທັນມາ', 'ລ້າງຖ້ວຍຈານ',

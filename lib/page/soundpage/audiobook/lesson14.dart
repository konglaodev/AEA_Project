...
class Lesson14 extends StatefulWidget {
  Lesson14({Key key, this.title}) : super(key: key);
  final String title;
  @override
...
class _Lesson14State extends State<Lesson14> {
  ...
  void _loadSound() async {
    final ByteData data = await rootBundle.load('sound/lesson14.mp3');
    Directory tempDir = await getTemporaryDirectory();
    File tempFile = File('${tempDir.path}/lesson14.mp3');
                ...
                child: Column(
                  children: <Widget>[
                    Row(
                      ...
                      children: [
                        SizedBox(
                          child: Image.asset('images/14.1.jpg'),
                          width: 700,
                        ),
                      ],
                    ),

...
class Lesson8 extends StatefulWidget {
  Lesson8({Key key, this.title}) : super(key: key);
  final String title;
  @override
...
class _Lesson8State extends State<Lesson8> {
  ...
  void _loadSound() async {
    final ByteData data = await rootBundle.load('sound/lesson8.mp3');
    Directory tempDir = await getTemporaryDirectory();
    File tempFile = File('${tempDir.path}/lesson8.mp3');
                ...
                child: Column(
                  children: <Widget>[
                    Row(
                      ...
                      children: [
                        SizedBox(
                          child: Image.asset('images/8.1.jpg'),
                          width: 700,
                        ),
                      ],
                    ),

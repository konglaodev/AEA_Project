...
class Lesson24 extends StatefulWidget {
  Lesson24({Key key, this.title}) : super(key: key);
  final String title;
  @override
...
class _Lesson24State extends State<Lesson24> {
  ...
  void _loadSound() async {
    final ByteData data = await rootBundle.load('sound/lesson24.mp3');
    Directory tempDir = await getTemporaryDirectory();
    File tempFile = File('${tempDir.path}/lesson24.mp3');
                ...
                child: Column(
                  children: <Widget>[
                    Row(
                      ...
                      children: [
                        SizedBox(
                          child: Image.asset('images/24.1.jpg'),
                          width: 700,
                        ),
                      ],
                    ),

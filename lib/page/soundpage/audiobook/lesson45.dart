...
class Lesson45 extends StatefulWidget {
  Lesson45({Key key, this.title}) : super(key: key);
  final String title;
  @override
  _Lesson45State createState() => _Lesson45State();
}
...
class _Lesson45State extends State<Lesson45> {
  ...
  void _loadSound() async {
    final ByteData data = await rootBundle.load('sound/lesson45.mp3');
    Directory tempDir = await getTemporaryDirectory();
    File tempFile = File('${tempDir.path}/lesson45.mp3');
                ...
                child: Column(
                  children: <Widget>[
                    Row(
                      ...
                      children: [
                        SizedBox(
                          child: Image.asset('images/45.1.jpg'),
                          width: 700,
                        ),
                      ],
                    ),

...
class Lesson34 extends StatefulWidget {
  Lesson34({Key key, this.title}) : super(key: key);
  final String title;
  @override
  _Lesson34State createState() => _Lesson34State();
}
...
class _Lesson34State extends State<Lesson34> {
  String mp3Uri = '';
  String mp32 = '';
  void _playSound() {
  ...
  void _loadSound() async {
    final ByteData data = await rootBundle.load('sound/lesson34.mp3');
    Directory tempDir = await getTemporaryDirectory();
    File tempFile = File('${tempDir.path}/lesson34.mp3');
                ...
                child: Column(
                  children: <Widget>[
                    Row(
                      ...
                      children: [
                        SizedBox(
                          child: Image.asset('images/34.1.jpg'),
                          width: 700,
                        ),
                      ],
                    ),

...
class Lesson12 extends StatefulWidget {
  Lesson12({Key key, this.title}) : super(key: key);
  final String title;
  @override
...
class _Lesson12State extends State<Lesson12> {
  ...
  void _loadSound() async {
    final ByteData data = await rootBundle.load('sound/lesson12.mp3');
    Directory tempDir = await getTemporaryDirectory();
    File tempFile = File('${tempDir.path}/lesson12.mp3');
                ...
                child: Column(
                  children: <Widget>[
                    Row(
                      ...
                      children: [
                        SizedBox(
                          child: Image.asset('images/12.1.jpg'),
                          width: 700,
                        ),
                      ],
                    ),

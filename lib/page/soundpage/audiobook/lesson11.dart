...
class Lesson11 extends StatefulWidget {
  Lesson11({Key key, this.title}) : super(key: key);
  final String title;
  @override
...
class _Lesson11State extends State<Lesson11> {
  ...
  void _loadSound() async {
    final ByteData data = await rootBundle.load('sound/lesson11.mp3');
    Directory tempDir = await getTemporaryDirectory();
    File tempFile = File('${tempDir.path}/lesson11.mp3');
                ...
                child: Column(
                  children: <Widget>[
                    Row(
                      ...
                      children: [
                        SizedBox(
                          child: Image.asset('images/11.1.jpg'),
                          width: 700,
                        ),
                      ],
                    ),

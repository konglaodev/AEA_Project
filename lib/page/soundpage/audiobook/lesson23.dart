...
class Lesson23 extends StatefulWidget {
  Lesson23({Key key, this.title}) : super(key: key);
  final String title;
  @override
...
class _Lesson23State extends State<Lesson23> {
  String mp3Uri = '';
  String mp32 = '';
  void _playSound() {
  ...
  void _loadSound() async {
    final ByteData data = await rootBundle.load('sound/lesson23.mp3');
    Directory tempDir = await getTemporaryDirectory();
    File tempFile = File('${tempDir.path}/lesson23.mp3');
                ...
                child: Column(
                  children: <Widget>[
                    Row(
                      ...
                      children: [
                        SizedBox(
                          child: Image.asset('images/23.1.jpg'),
                          width: 700,
                        ),
                      ],
                    ),

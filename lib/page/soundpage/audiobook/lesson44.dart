...
class Lesson44 extends StatefulWidget {
  Lesson44({Key key, this.title}) : super(key: key);
  final String title;
  @override
  _Lesson44State createState() => _Lesson44State();
}
...
class _Lesson44State extends State<Lesson44> {
  ...
  void _loadSound() async {
    final ByteData data = await rootBundle.load('sound/lesson44.mp3');
    Directory tempDir = await getTemporaryDirectory();
    File tempFile = File('${tempDir.path}/lesson44.mp3');
                ...
                child: Column(
                  children: <Widget>[
                    Row(
                      ...
                      children: [
                        SizedBox(
                          child: Image.asset('images/44.1.jpg'),
                          width: 700,
                        ),
                      ],
                    ),

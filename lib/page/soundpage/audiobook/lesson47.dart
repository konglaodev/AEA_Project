...
class Lesson47 extends StatefulWidget {
  Lesson47({Key key, this.title}) : super(key: key);
  final String title;
  @override
  _Lesson47State createState() => _Lesson47State();
}
...
class _Lesson47State extends State<Lesson47> {
  ...
  void _loadSound() async {
    final ByteData data = await rootBundle.load('sound/lesson47.mp3');
    Directory tempDir = await getTemporaryDirectory();
    File tempFile = File('${tempDir.path}/lesson47.mp3');
                ...
                child: Column(
                  children: <Widget>[
                    Row(
                      ...
                      children: [
                        SizedBox(
                          child: Image.asset('images/47.1.jpg'),
                          width: 700,
                        ),
                      ],
                    ),

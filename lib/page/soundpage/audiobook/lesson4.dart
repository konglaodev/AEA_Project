...
class Lesson4 extends StatefulWidget {
  Lesson4({Key key, this.title}) : super(key: key);
  final String title;
  @override
...
class _Lesson4State extends State<Lesson4> {
  ...
  void _loadSound() async {
    final ByteData data = await rootBundle.load('sound/lesson4.mp3');
    Directory tempDir = await getTemporaryDirectory();
    File tempFile = File('${tempDir.path}/lesson4.mp3');
                ...
                child: Column(
                  children: <Widget>[
                    Row(
                      ...
                      children: [
                        SizedBox(
                          child: Image.asset('images/4.1.jpg'),
                          width: 700,
                        ),
                      ],
                    ),

...
class Lesson6 extends StatefulWidget {
  Lesson6({Key key, this.title}) : super(key: key);
  final String title;
  @override
...
class _Lesson6State extends State<Lesson6> {
  ...
  void _loadSound() async {
    final ByteData data = await rootBundle.load('sound/lesson6.mp3');
    Directory tempDir = await getTemporaryDirectory();
    File tempFile = File('${tempDir.path}/lesson6.mp3');
                ...
                child: Column(
                  children: <Widget>[
                    Row(
                      ...
                      children: [
                        SizedBox(
                          child: Image.asset('images/6.1.jpg'),
                          width: 700,
                        ),
                      ],
                    ),

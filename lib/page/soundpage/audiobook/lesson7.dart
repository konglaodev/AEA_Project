...
class Lesson7 extends StatefulWidget {
  Lesson7({Key key, this.title}) : super(key: key);
  final String title;
  @override
...
class _Lesson7State extends State<Lesson7> {
  ...
  void _loadSound() async {
    final ByteData data = await rootBundle.load('sound/lesson7.mp3');
    Directory tempDir = await getTemporaryDirectory();
    File tempFile = File('${tempDir.path}/lesson7.mp3');
                ...
                child: Column(
                  children: <Widget>[
                    Row(
                      ...
                      children: [
                        SizedBox(
                          child: Image.asset('images/7.1.jpg'),
                          width: 700,
                        ),
                      ],
                    ),

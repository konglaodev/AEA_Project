...
class Lesson37 extends StatefulWidget {
  Lesson37({Key key, this.title}) : super(key: key);
  final String title;
  @override
  _Lesson37State createState() => _Lesson37State();
}
...
class _Lesson37State extends State<Lesson37> {
  ...
  void _loadSound() async {
    final ByteData data = await rootBundle.load('sound/lesson37.mp3');
    Directory tempDir = await getTemporaryDirectory();
    File tempFile = File('${tempDir.path}/lesson37.mp3');
                ...
                child: Column(
                  children: <Widget>[
                    Row(
                      ...
                      children: [
                        SizedBox(
                          child: Image.asset('images/37.1.jpg'),
                          width: 700,
                        ),
                      ],
                    ),

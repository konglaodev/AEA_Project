...
class Lesson42 extends StatefulWidget {
  Lesson42({Key key, this.title}) : super(key: key);
  final String title;
  @override
  _Lesson42State createState() => _Lesson42State();
}
...
class _Lesson42State extends State<Lesson42> {
  ...
  void _loadSound() async {
    final ByteData data = await rootBundle.load('sound/lesson42.mp3');
    Directory tempDir = await getTemporaryDirectory();
    File tempFile = File('${tempDir.path}/lesson42.mp3');
                ...
                child: Column(
                  children: <Widget>[
                    Row(
                      ...
                      children: [
                        SizedBox(
                          child: Image.asset('images/42.1.jpg'),
                          width: 700,
                        ),
                      ],
                    ),

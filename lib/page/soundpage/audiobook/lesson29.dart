...
class Lesson29 extends StatefulWidget {
  Lesson29({Key key, this.title}) : super(key: key);
  final String title;
  @override
  _Lesson29State createState() => _Lesson29State();
}
...
class _Lesson29State extends State<Lesson29> {
  String mp3Uri = '';
  String mp32 = '';
  void _playSound() {
  ...
  void _loadSound() async {
    final ByteData data = await rootBundle.load('sound/lesson29.mp3');
    Directory tempDir = await getTemporaryDirectory();
    File tempFile = File('${tempDir.path}/lesson29.mp3');
                ...
                child: Column(
                  children: <Widget>[
                    Row(
                      ...
                      children: [
                        SizedBox(
                          child: Image.asset('images/29.1.jpg'),
                          width: 700,
                        ),
                      ],
                    ),
                    Row(
                      ...
                      children: [
                        SizedBox(
                          child: Image.asset('images/29.2.jpg'),
                          width: 700,
                        ),
                      ],
                    ),

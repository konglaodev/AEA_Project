...
class Lesson26 extends StatefulWidget {
  Lesson26({Key key, this.title}) : super(key: key);
  final String title;
  @override
  _Lesson26State createState() => _Lesson26State();
}
...
class _Lesson26State extends State<Lesson26> {
  String mp3Uri = '';
  String mp32 = '';
  void _playSound() {
  ...
  void _loadSound() async {
    final ByteData data = await rootBundle.load('sound/lesson26.mp3');
    Directory tempDir = await getTemporaryDirectory();
    File tempFile = File('${tempDir.path}/lesson26.mp3');
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          elevation: 0.0,
          title: Text('ບຸນເກີຂອງເຜົ່າກືມມຸ'),
        ),
        body: Container(
          child: SafeArea(
                ...
                child: Column(
                  children: <Widget>[
                    Row(
                      ...
                      children: [
                        SizedBox(
                          child: Image.asset('images/26.1.jpg'),
                          width: 700,
                        ),
                      ],
                    ),
                    Row(
                      ...
                      children: [
                        SizedBox(
                          child: Image.asset('images/26.2.jpg'),
                          width: 700,
                        ),
                      ],
                    ),

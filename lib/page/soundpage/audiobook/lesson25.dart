...
class Lesson25 extends StatefulWidget {
  Lesson25({Key key, this.title}) : super(key: key);
  final String title;
  @override
...
class _Lesson25State extends State<Lesson25> {
  String mp3Uri = '';
  String mp32 = '';
  void _playSound() {
  ...
  void _loadSound() async {
    final ByteData data = await rootBundle.load('sound/lesson25.mp3');
    Directory tempDir = await getTemporaryDirectory();
    File tempFile = File('${tempDir.path}/lesson25.mp3');
                ...
                child: Column(
                  children: <Widget>[
                    Row(
                      ...
                      children: [
                        SizedBox(
                          child: Image.asset('images/25.1.jpg'),
                          width: 700,
                        ),
                      ],
                    ),

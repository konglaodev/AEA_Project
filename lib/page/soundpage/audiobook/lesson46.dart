...
class Lesson46 extends StatefulWidget {
  Lesson46({Key key, this.title}) : super(key: key);
  final String title;
  @override
  _Lesson46State createState() => _Lesson46State();
}
...
class _Lesson46State extends State<Lesson46> {
  ...
  void _loadSound() async {
    final ByteData data = await rootBundle.load('sound/lesson46.mp3');
    Directory tempDir = await getTemporaryDirectory();
    File tempFile = File('${tempDir.path}/lesson46.mp3');
                ...
                child: Column(
                  children: <Widget>[
                    Row(
                      ...
                      children: [
                        SizedBox(
                          child: Image.asset('images/46.1.jpg'),
                          width: 700,
                        ),
                      ],
                    ),

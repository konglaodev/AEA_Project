...
class Lesson27 extends StatefulWidget {
  Lesson27({Key key, this.title}) : super(key: key);
  final String title;
  @override
  _Lesson27State createState() => _Lesson27State();
}
...
class _Lesson27State extends State<Lesson27> {
  String mp3Uri = '';
  String mp32 = '';
  void _playSound() {
  ...
  void _loadSound() async {
    final ByteData data = await rootBundle.load('sound/lesson27.mp3');
    Directory tempDir = await getTemporaryDirectory();
    File tempFile = File('${tempDir.path}/lesson27.mp3');
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          elevation: 0.0,
          title: Text('ບຸນກີນຈຽງຂອງເຜົ່າມົ້ງ'),
        ),
        body: Container(
          child: SafeArea(
                ...
                child: Column(
                  children: <Widget>[
                    Row(
                      ...
                      children: [
                        SizedBox(
                          child: Image.asset('images/27.1.jpg'),
                          width: 700,
                        ),
                      ],
                    ),
                    Row(
                      ...
                      children: [
                        SizedBox(
                          child: Image.asset('images/27.2.jpg'),
                          width: 700,
                        ),
                      ],
                    ),

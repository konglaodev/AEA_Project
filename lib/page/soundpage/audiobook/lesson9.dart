...
class Lesson9 extends StatefulWidget {
  Lesson9({Key key, this.title}) : super(key: key);
  final String title;
  @override
...
class _Lesson9State extends State<Lesson9> {
  ...
  void _loadSound() async {
    final ByteData data = await rootBundle.load('sound/lesson9.mp3');
    Directory tempDir = await getTemporaryDirectory();
    File tempFile = File('${tempDir.path}/lesson9.mp3');
                ...
                child: Column(
                  children: <Widget>[
                    Row(
                      ...
                      children: [
                        SizedBox(
                          child: Image.asset('images/9.1.jpg'),
                          width: 700,
                        ),
                      ],
                    ),

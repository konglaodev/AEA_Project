...
class Lesson48 extends StatefulWidget {
  Lesson48({Key key, this.title}) : super(key: key);
  final String title;
  @override
  _Lesson48State createState() => _Lesson48State();
}
...
class _Lesson48State extends State<Lesson48> {
  ...
  void _loadSound() async {
    final ByteData data = await rootBundle.load('sound/lesson48.mp3');
    Directory tempDir = await getTemporaryDirectory();
    File tempFile = File('${tempDir.path}/lesson48.mp3');
                ...
                child: Column(
                  children: <Widget>[
                    Row(
                      ...
                      children: [
                        SizedBox(
                          child: Image.asset('images/48.1.jpg'),
                          width: 700,
                        ),
                      ],
                    ),

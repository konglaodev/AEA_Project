...
class Lesson5 extends StatefulWidget {
  Lesson5({Key key, this.title}) : super(key: key);
  final String title;
  @override
...
class _Lesson5State extends State<Lesson5> {
  ...
  void _loadSound() async {
    final ByteData data = await rootBundle.load('sound/lesson5.mp3');
    Directory tempDir = await getTemporaryDirectory();
    File tempFile = File('${tempDir.path}/lesson5.mp3');
                ...
                child: Column(
                  children: <Widget>[
                    Row(
                      ...
                      children: [
                        SizedBox(
                          child: Image.asset('images/5.1.jpg'),
                          width: 700,
                        ),
                      ],
                    ),
